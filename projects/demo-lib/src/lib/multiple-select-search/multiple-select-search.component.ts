...
@Component({
  selector: 'lib-multiple-select-search',
  templateUrl: './multiple-select-search.component.html',
  styleUrls: ['./multiple-select-search.component.css']
})
export class MultipleSelectSearchComponent implements OnInit, AfterViewInit, OnDestroy {
